...
export const Constants = {
    ...
    COMPLETE: "COMPLETE",
    ADD_TODO : "ADD_TODO",   
    ADD_TODO_BTN: "Add a Project",
    TODO_PLACEHOLDER: "Add Project here",
    ADD_BTN_TEXT: "Add",
    ERROR_MESSAGE: "It seems you have not entered project!",
    ...
    PROJECT_OBJ: {name:"BINANCE", projectList: "PROJECT RELEASE LISTS"},
